...
public class LoanReschedulingWithinCenterTest {
    ...
    public void testCenterReschedulingLoansWithInterestRecalculationEnabled() {
        ...
        final String disbursalDate = "25 November 2015";
        ...
        String oldMeetingDate = "20 January 2016";
        String centerMeetingNewStartDate = "21 January 2016";
        ...
        ArrayList dueDateLoanSchedule = (ArrayList) ((HashMap) loanRepaymnetSchedule.get(4)).get("dueDate");
        Calendar date = Calendar.getInstance(Utils.getTimeZoneOfTenant());
        date.set(2016, Calendar.JANUARY, 21);
        assertEquals(getDateAsArray(date, 0), dueDateLoanSchedule);

        // VERIFY THE INTEREST
        Float interestDue = (Float) ((HashMap) loanRepaymnetSchedule.get(4)).get("interestDue");
        assertEquals(String.valueOf(interestDue), "97.06");
    ...
    private Integer createCalendarMeeting(Integer centerId) {
        final String startDate = "09 December 2015";
        final String frequency = "2"; // 2:Weekly
        final String interval = "2"; // Every one week
        final String repeatsOnDay = "3"; // 3:Wednesday
    ...
    public void testCenterReschedulingMultiTrancheLoansWithInterestRecalculationEnabled() {
        ...
        // CREATE A LOAN PRODUCT
        final String approveDate = "25 November 2015";
        final String expectedDisbursementDate = "25 November 2015";
        final String disbursementDate = "25 November 2015";
        ...
        createTranches.add(this.loanApplicationApprovalTest.createTrancheDetail("25 November 2015", "5000"));
        createTranches.add(this.loanApplicationApprovalTest.createTrancheDetail("01 March 2016", "5000"));

        // APPROVE TRANCHES
        List<HashMap> approveTranches = new ArrayList<>();
        approveTranches.add(this.loanApplicationApprovalTest.createTrancheDetail("25 November 2015", "5000"));
        approveTranches.add(this.loanApplicationApprovalTest.createTrancheDetail("01 March 2016", "5000"));
        ...
        // VERIFY THE INTEREST
        Float interestDue = (Float) ((HashMap) loanRepaymnetSchedule.get(4)).get("interestDue");
        assertEquals(String.valueOf(interestDue), "47.66");
